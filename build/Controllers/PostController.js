    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Post.findById(postIdValidation)
                        .select("_id title description image vote createdAt updatedAt")
                        .populate("user", "username name surname")];
            case 2:
                getPosts = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Post.findByIdAndDelete(postIdValidation)];
            case 2:
                deletePosts = _a.sent();
                if (deletePosts) {
                    res.status(200).json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!PostValidation_2.UpdatePostValidation) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Operation failed, invalid details provided.",
                        }))];
                }
                return [4 /*yield*/, Post.findByIdAndUpdate({
